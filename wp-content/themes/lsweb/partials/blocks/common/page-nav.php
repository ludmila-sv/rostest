...
if ( ! empty( $block['data']['is_preview'] ) ) {
	...
	<nav id="<?php echo esc_attr( $block_id ); ?>" class="<?php echo esc_attr( $class_name ); ?>">
		<div class="container">
					...
					<div class="page-nav__menu">
						<ul>
							...
							while ( have_rows( 'menu' ) ) :
								...
								$li_class = get_sub_field( 'has_submenu' ) ? ' class="has-submenu"' : '';
								?>

								<li<?php echo $li_class; //phpcs:ignore ?>>
											...
											<div class="page-nav__submenu__inner">
												<ul>
													...
													while ( have_rows( 'submenu' ) ) :
														...
														<li><a class="page-nav__a scroll-to" href="<?php echo esc_url( $submenu_url ); ?>"<?php echo esc_attr( $submenu_target ); ?>><?php echo esc_html( $submenu_title ); ?></a></li>
